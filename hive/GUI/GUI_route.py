...
class App(ttk.Frame):
    ...
    def __create_widgets(self):
        ...
        tk.Button(self, text="Clear", command=lambda: GUI_functionality.clearCanvas(canvas)).grid(column=1, row=6)
        ...
        tk.Button(self, text="NOT FREE", command=lambda: GUI_functionality.requestMap(canvas, self.img), bg="red").grid(column=1, row=7)
