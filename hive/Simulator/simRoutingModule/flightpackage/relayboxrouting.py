...
tello_host = '127.0.0.1'  #'192.168.10.1'
tello_port = 8889   # 8889
...
def downlink():
    while True:
        ...
        #print(DataArr)
        if len(DataArr) == 2:
            data = bytes(DataArr[1], "UTF-8")
        if data == b'ok':
            print("ok")
        elif data == b'error':
            print("error")
        elif DataArr[0] == "b'0.0.0.0":
